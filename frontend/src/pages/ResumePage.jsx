  ...
  return (
    <>
      {(status === 'idle' || status === 'error') && (
        <>
          <ResumeInputForm onSubmit={reviewResume} disabled={false} />
          {status === 'error' && (
            <div style={{
              marginTop: '1rem',
        ...
        <div style={{ marginTop: '1rem' }}>
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{ fontSize: '0.9rem', color: '#475569' }}>Reviewing...</span>
            </div>
            <button
              onClick={cancel}
              style={{
      ...
      {status === 'complete' && result && (
        <div style={{ marginTop: '1rem' }}>
          <ResumeResultsView result={result} />

          <div style={{ marginTop: '2rem' }}>
            <BulletWorkshop
              weakBullets={result.weak_bullets}
